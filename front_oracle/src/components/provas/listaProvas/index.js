...
export function ListaProvas() {
    ...
    return (
        <View style={stylesListaProvas.container}>
            <TouchableOpacity
                style={stylesListaProvas.itemContainer}
                onPress={() => {
            ...
            >
                <View style={stylesListaProvas.containerUser}>
                    <View style={stylesListaProvas.textContainer}>
                        <Text style={stylesListaProvas.name} numberOfLines={1}>
                            Hardware
                        </Text>
                        <Text style={stylesListaProvas.email}>
                            Realizar prova de Hardware
                        </Text>
                    </View>
                    <Ionicons
