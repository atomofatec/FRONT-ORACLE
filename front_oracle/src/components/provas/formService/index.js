...
export function FormService({ onOptionChange }) {
    ...
    return (
        <View style={stylesFormService.container}>
            <Text style={stylesFormService.titleUser}>
                1.Qual é o principal objetivo do Oracle Service?
            </Text>
            ...
            <Text style={stylesFormService.titleUser}>
                2.Qual tecnologia é usada pelo Oracle Service para garantir alta
            ...
            <Text style={stylesFormService.titleUser}>
                3.Qual dos seguintes não é um serviço oferecido pelo Oracle
                Service?
            </Text>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
                <RadioButton
